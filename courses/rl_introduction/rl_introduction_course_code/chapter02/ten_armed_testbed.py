...
# AGG backend is for writing to file
# matplotlib.use('Agg')
...
def figure_2_1(save=False):
    dataset=np.random.randn(200, 10) + np.random.randn(10)
    print(f"mean across row={dataset.mean(axis=0)}, \nstd= {dataset.std(axis=0)}")
    print(f"mean of all={dataset.mean()}, std= {dataset.std()}")
